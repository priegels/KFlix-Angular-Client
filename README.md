# KFlix-Angular-Client

This project was generated with [Angular CLI](https://github.com/angular/angular-cli) version 13.2.5.

Angular has been used to build the client-side for an application called KFlix. It is based on its existing server-side code (REST API and database), with supporting documentation.
